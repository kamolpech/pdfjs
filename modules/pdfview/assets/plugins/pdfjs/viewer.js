...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = '../assets/plugins/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = './cmaps/';
...
function getViewerConfiguration() {
  ...
  var pdf_file = document.getElementsByClassName('pdfViewer');
  if(pdf_file){
    DEFAULT_URL = pdf_file[0].getAttribute('data-pdf-file');
  }
